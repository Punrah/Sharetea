...
public class PromoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myInflater = inflater.inflate(R.layout.fragment_promo, container, false);

        Spinner spinner = (Spinner) myInflater.findViewById(R.id.spinner);
...
// Apply the adapter to the spinner
    ...
    {
        mAdapter = new PromoAdapter(getActivity(),listItem);
